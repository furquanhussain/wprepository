...
$('.search_keywords #search_keywords').change(function() {
    ...
    $('.job_filters #search_keywords').val($(this).val());
});
    /*----------------------------------------------------*/
    /*  Navigation
    /*----------------------------------------------------*/
...
// For English option show description

(function($) {
	jQuery('#english').on('change', function(evt, params) {
   // console.log(jQuery(this).text());
    var op_txt = jQuery(this).val();
    var msg= '';
    if(op_txt=="basic"){
		msg = op_txt.toUpperCase()+": You can understand "+op_txt+" english in reading.";
	} if(op_txt=="medium"){
		msg = op_txt.toUpperCase()+": You can understand "+op_txt+" english in reading.";
	} if(op_txt=="high"){
		msg = op_txt.toUpperCase()+": You can understand "+op_txt+" english in reading.";
	}
    jQuery('.fieldset-english').find('small.description').text(msg);
  });
})(jQuery);