...
jQuery(document).ready(function() {
	...
	/* Show message modal for private message custom btn */
	jQuery(document).on('click', '.um-custom-pm-btn:not(.um-login-to-msg-btn), *[data-trigger_modal="conversation"]',function(e){
		if ( jQuery(this).attr('data-trigger_modal') && jQuery('.um-message-conv-view').is(':visible') ) return false;
		e.preventDefault();
